                ...
                <v-card color="rgba(0, 0, 0, 0.0" flat tile>
                  ...
                  <v-menu offset-x>
                    <template v-slot:activator="{ on }">
                      <v-btn  v-on="on" > {{ location }} <v-icon color="red" right="" >location_on</v-icon> </v-btn>
                    </template>
                  ...
                  <v-btn  @click="register(email, password, name)">Next<v-icon color="green" right="" >arrow_forward</v-icon></v-btn>
